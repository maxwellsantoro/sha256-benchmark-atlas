/* Direct OpenSSL EVP SHA-256 runner.
 * Usage:
 *   sha256_runner hash                 # stdin → hex digest
 *   sha256_runner bench SIZE ITERS SEED
 *     → JSON: {"ns_total":N,"hashes":N,"digest":"...","size":N}
 */
...
/* Batch verify: repeated [u32 BE length][msg bytes] → hex digest per record */
